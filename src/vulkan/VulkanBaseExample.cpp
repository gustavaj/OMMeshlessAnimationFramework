...
void VulkanExampleBase::renderFrame()
{
	...
	if (fpsTimer > 1000.0f)
	{
		...
		frameTimerHistory[frameTimerIndex] = lastFPS;
		frameTimerIndex = (frameTimerIndex + 1) % frameTimerHistory.size();
#if defined(_WIN32)
		if (!settings.overlay) {
...
void VulkanExampleBase::updateOverlay(double dt)
{
	...
	// TODO: How to be able to input text to input fields in imgui?
	io.ClearInputCharacters();
	if (numberInput.k0 && !numberInput.k0_handled) { io.AddInputCharacter('0'); numberInput.k0_handled = true; }
	if (numberInput.k1 && !numberInput.k1_handled) { io.AddInputCharacter('1'); numberInput.k1_handled = true; }
	if (numberInput.k2 && !numberInput.k2_handled) { io.AddInputCharacter('2'); numberInput.k2_handled = true; }
	if (numberInput.k3 && !numberInput.k3_handled) { io.AddInputCharacter('3'); numberInput.k3_handled = true; }
	if (numberInput.k4 && !numberInput.k4_handled) { io.AddInputCharacter('4'); numberInput.k4_handled = true; }
	if (numberInput.k5 && !numberInput.k5_handled) { io.AddInputCharacter('5'); numberInput.k5_handled = true; }
	if (numberInput.k6 && !numberInput.k6_handled) { io.AddInputCharacter('6'); numberInput.k6_handled = true; }
	if (numberInput.k7 && !numberInput.k7_handled) { io.AddInputCharacter('7'); numberInput.k7_handled = true; }
	if (numberInput.k8 && !numberInput.k8_handled) { io.AddInputCharacter('8'); numberInput.k8_handled = true; }
	if (numberInput.k9 && !numberInput.k9_handled) { io.AddInputCharacter('9'); numberInput.k9_handled = true; }
	if (numberInput.kPeriod && !numberInput.kPeriod_handled) { io.AddInputCharacter('.'); numberInput.kPeriod_handled = true; }
	if (numberInput.kMinus && !numberInput.kMinus_handled) { io.AddInputCharacter('-'); numberInput.kMinus_handled = true; }
	io.WantCaptureKeyboard = true;
	io.KeysDown[KEY_RETURN] = numberInput.kReturn;
	io.KeyMap[ImGuiKey_Backspace] = numberInput.kBackspace;
	...
	ImGui::Begin("Menu", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
...
void VulkanExampleBase::handleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case KEY_ESCAPE:
			PostQuitMessage(0);
			break;
		case KEY_0: case KEY_NUM_0: numberInput.k0 = true; break;
		case KEY_1: case KEY_NUM_1: numberInput.k1 = true; break;
		case KEY_2: case KEY_NUM_2: numberInput.k2 = true; break;
		case KEY_3: case KEY_NUM_3: numberInput.k3 = true; break;
		case KEY_4: case KEY_NUM_4: numberInput.k4 = true; break;
		case KEY_5: case KEY_NUM_5: numberInput.k5 = true; break;
		case KEY_6: case KEY_NUM_6: numberInput.k6 = true; break;
		case KEY_7: case KEY_NUM_7: numberInput.k7 = true; break;
		case KEY_8: case KEY_NUM_8: numberInput.k8 = true; break;
		case KEY_9: case KEY_NUM_9: numberInput.k9 = true; break;
		case KEY_RETURN: numberInput.kReturn = true; break;
		case KEY_BACKSPACE: numberInput.kBackspace = true; break;
		case KEY_PERIOD: numberInput.kPeriod = true; break;
		case KEY_MINUS: numberInput.kMinus = true; break;
		}
